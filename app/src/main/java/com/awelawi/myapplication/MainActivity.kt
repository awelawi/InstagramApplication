...
import com.awelawi.myapplication.fragments.ComposeFragment
import com.awelawi.myapplication.fragments.HomeFragment
import com.awelawi.myapplication.fragments.ProfileFragment
...
//        }
        findViewById<BottomNavigationView>(R.id.bottom_navigation).setOnItemReselectedListener {
            ...
            //RETURN TRUE SIGNIFIES THAT WE'VE HANDLED USER INTERACTION
            true
        }
